...
mod tests {
    ...
    const CHANNEL_ID: &str = "1hw3cyxo87f17rnwq9ocus48de";
    const TOKEN: &str = "5y9949h48tg19bn4x84dexmf8y";
    const BASE_URL: &str = "https://mm.uno-cnc.com";
    ...
    #[test]
    fn auth_get() {
        let res = client().get("/api/v4/channels").unwrap();
        println!("{res:#?}");
    }

    #[test]
    fn create_post() {
        let res = client().create_post(CHANNEL_ID, "I'm robalo le robot!");
        println!("{res:#?}");
    }
}
